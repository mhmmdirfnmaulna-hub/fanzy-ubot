    ...
    def emit(self, record):
        for X in ["OSError", "TimeoutError"]:
            if X in record.getMessage():
                os.system(f"kill -30 {os.getpid()} && python3 -m fanzy")
...
class Bot(Client):
    def __init__(self, **kwargs):
        super().__init__(**kwargs, device_model="fanzybot")
...
ubot = Ubot(name="userbot")

from fanzy.core.database import *
from fanzy.core.function import *
from fanzy.core.helpers import *